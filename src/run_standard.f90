...
use experiment_module,      only: experiment_standard
...
output_filename = get_output_filename('runs_standard', 'rk4', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
call experiment_standard(X0, t0, tmax, timesteps, f, rk4, output_filename)

! Run simulations with rk3 (Heun)
output_filename = get_output_filename('runs_standard', 'rk3_heun', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
call experiment_standard(X0, t0, tmax, timesteps, f, rk3_heun, output_filename)

! Run simulations with rk3 (Kutta)
output_filename = get_output_filename('runs_standard', 'rk3_kutta', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
call experiment_standard(X0, t0, tmax, timesteps, f, rk3_kutta, output_filename)

! Run simulations with rk2
output_filename = get_output_filename('runs_standard', 'rk2', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
call experiment_standard(X0, t0, tmax, timesteps, f, rk2, output_filename)

! Run simulations with rk1 (Euler's method)
output_filename = get_output_filename('runs_standard', 'rk1', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
call experiment_standard(X0, t0, tmax, timesteps, f, rk1, output_filename)
