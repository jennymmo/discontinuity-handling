...
initial_position_filename   = trim(input_folder) // 'initial_positions_nordic4_backwards_standard.txt'
...
output_filename = get_output_filename('backward_run_standard', 'rk4', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
print*, 'Xref = ', Xref

call experiment_standard(X0, t0, tmax, timesteps, f, rk4, output_filename, .true.)
