...
output_filename = get_output_filename('runs_discontinuity_handling', 'rk4', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
callfactor=1._DP / 4._DP
call experiment_discontinuity_handling(X0, t0, tmax, timesteps, f, rk4, output_filename, Xref, resolution, callfactor)

! Run simulations with rk3 (Heun)
output_filename = get_output_filename('runs_discontinuity_handling', 'rk3_heun', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
callfactor=1._DP / 3._DP
call experiment_discontinuity_handling(X0, t0, tmax, timesteps, f, rk3_heun, output_filename, Xref, resolution, callfactor)

! Run simulations with rk3 (Kutta)
output_filename = get_output_filename('runs_discontinuity_handling', 'rk3_kutta', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
callfactor=1._DP / 3._DP
call experiment_discontinuity_handling(X0, t0, tmax, timesteps, f, rk3_kutta, output_filename, Xref, resolution, callfactor)

! Run simulations with rk2
output_filename = get_output_filename('runs_discontinuity_handling', 'rk2', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
callfactor=1._DP / 2._DP
call experiment_discontinuity_handling(X0, t0, tmax, timesteps, f, rk2, output_filename, Xref, resolution, callfactor)

! Run simulations with rk1 (Euler's method)
output_filename = get_output_filename('runs_discontinuity_handling', 'rk1', dataset_name, order)
print*, 'Running simulation with timesteps ', timesteps
print*, 'Storing results to ', output_filename
callfactor=1._DP
call experiment_discontinuity_handling(X0, t0, tmax, timesteps, f, rk1, output_filename, Xref, resolution, callfactor)
